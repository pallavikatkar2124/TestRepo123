...
public class TestClass2 {
   ...
   @Test
    public void test1() {
	System.out.println("TestClass2 before test1");
}

   @Test
    public void test2() {
	System.out.println("TestClass2 before test2");
}
   @Test
   public void test3() {
	System.out.println("TestClass2 before test3");
}
   @Test
   public void test4() {
	System.out.println("TestClass2 before test4");
}
   @AfterMethod
